...
#pragma warning restore 618
    {
        ...
        public GameObject udon_mealPrefab;
        public GameObject SushiPrefab;
        public GameObject hotdogPrefab;
        public GameObject applePiePrefab;

        private GameObject udonObject;
        private GameObject sushiObject;
        private GameObject hotdogObject;
        private GameObject applePieObject;
...
#pragma warning disable 618
        [Command]
#pragma warning restore 618
        public void CmdSpawnUdon(Vector3 position, Quaternion rotation)
        {
            // Instantiate Star model at the hit pose.
            udonObject = Instantiate(udon_mealPrefab, position, rotation);

            // Spawn the object in all clients.
#pragma warning disable 618
            NetworkServer.Spawn(udonObject);
#pragma warning restore 618
        ...
        [Command]
#pragma warning restore 618
        public void CmdSpawnSushi(Vector3 position, Quaternion rotation)
        {
            // Instantiate Star model at the hit pose.
            sushiObject = Instantiate(SushiPrefab, position, rotation);

            // Spawn the object in all clients.
#pragma warning disable 618
            NetworkServer.Spawn(sushiObject);
#pragma warning restore 618
        ...
        [Command]
#pragma warning restore 618
        public void CmdSpawnHotdog(Vector3 position, Quaternion rotation)
        {
            // Instantiate Star model at the hit pose.
            hotdogObject = Instantiate(hotdogPrefab, position, rotation);

            // Spawn the object in all clients.
#pragma warning disable 618
            NetworkServer.Spawn(hotdogObject);
#pragma warning restore 618
        ...
        [Command]
#pragma warning restore 618
        public void CmdSpawnApplePie(Vector3 position, Quaternion rotation)
        {
            //Instantiate Star model at the hit pose.
            applePieObject = Instantiate(applePiePrefab, position, rotation);

            // Spawn the object in all clients.
#pragma warning disable 618
            NetworkServer.Spawn(applePieObject);
#pragma warning restore 618
        ...
        /// <summary>
        /// A command run on the server that will destroy the Objects prefab in all clients.
        /// </summary>

#pragma warning disable 618
        [Command]
#pragma warning restore 618
        public void CmdDestroyUdon()
        {
            Destroy(udonObject);
...
#pragma warning restore 618
        ...
        [Command]
#pragma warning restore 618
        public void CmdDestroyHotdog()
        {
            Destroy(hotdogObject);

        }

        [Command]
#pragma warning restore 618
        public void CmdDestroyApplePie()
        {
            Destroy(applePieObject);
